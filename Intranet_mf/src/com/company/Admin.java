...
public class Admin extends Person implements Serializable {
    ...
    public static HashMap<String, Admin> get() throws IOException, ClassNotFoundException{
        try{
            ObjectInputStream OInputStream = new ObjectInputStream(new FileInputStream("Desktop\\OOP 2018 Fall\\Intranet_mf\\src\\com\\company\\Files\\Admins.out"));
    ...
    public static void save(HashMap<String, Admin> admins) throws IOException{
        try{
            ObjectOutputStream OOutputStream =  new ObjectOutputStream(new FileOutputStream("Desktop\\OOP 2018 Fall\\Intranet_mf\\src\\com\\company\\Files\\Admins.out"));
